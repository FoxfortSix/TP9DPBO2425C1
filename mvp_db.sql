...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2025 at 03:19 AM
...
CREATE TABLE `sirkuit` (
  ...
  `nama` varchar(255) NOT NULL,
  `negara` varchar(255) NOT NULL,
  `panjang_km` float NOT NULL,
  `jumlah_tikungan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sirkuit` (`id`, `nama`, `negara`, `panjang_km`, `jumlah_tikungan`) VALUES
(1, 'Monza', 'Italy', 5.793, 11),
(2, 'Spa-Francorchamps', 'Belgium', 7.004, 19),
(3, 'Silverstone', 'United Kingdom', 5.891, 18),
(4, 'Suzuka', 'Japan', 5.807, 18),
(5, 'Mandalika', 'Indonesia', 4.313, 17);
